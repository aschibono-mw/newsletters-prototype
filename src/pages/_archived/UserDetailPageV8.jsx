...
function UserDetailPageV8() {
  ...
  const handleTabChange = (event, newValue) => {
    ...
    navigate(`/seats-v8/users/${userId}/${newTab}`, { replace: true })
  }
  ...
  if (!user || !localUser) {
    return (
      <Box sx={{ p: 3 }}>
        ...
        <Button onClick={() => navigate('/seats-v8')} sx={{ mt: 2 }}>
          Back to Users
        </Button>
      </Box>
    )
...
export default UserDetailPageV8
